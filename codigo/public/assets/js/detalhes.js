...
function exibirDetalhes(medicamento) {
    ...
    const caminhoCompleto = medicamento.imagem 
        ? `${basePath}${medicamento.imagem}` 
        : `${basePath}/images/produtos/padrao.jpg`;
            ...
            <div class="cabecalho-detalhes">
                <div class="imagem-titulo">
                    <img src="${caminhoCompleto}" 
                         ...
                         class="imagem-grande"
                         onerror="this.onerror=null; this.src='${basePath}/images/produtos/padrao.jpg'">
                    <div>
...
function editarMedicamento(id) {
    window.location.href = `modulos/medicamentos/meus-medicamentos.html?edit=${id}`;
}
        ...
        fetch(`${API_URL}/${id}`, {
            ...
            .then(response => {
                if (response.ok) {
                    ...
                    window.location.href = 'modulos/medicamentos/meus-medicamentos.html';
                } else {
